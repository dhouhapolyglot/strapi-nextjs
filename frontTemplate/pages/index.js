...
export const getStaticProps = async () => {
  ...
  axios.get('http://localhost:1337/api/homes').then(response => {
    banner.title = response.data.data[0].attributes.title
    banner.title_small = response.data.data[0].attributes.title_small
    banner.content= response.data.data[0].attributes.content
  });
  return {
    props: {
      banner: banner,
